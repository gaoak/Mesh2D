...
void DefineBLParams(std::map<std::string, double> &p,
  ...
  int nUp0 = 0.5 * Thickness / maxLayerh + 4;
  q["nUp0"] = nUp0;
  ...
  q["nUp4"] = nUp4;
  int nUp5 = 0.5 * Thickness / maxLayerh + 4;
  q["nUp5"] = nUp5;
  int nLow0 = 0.5 * Thickness / maxLayerh + 4;
  q["nLow0"] = nLow0;
  ...
  q["nLow4"] = nLow4;
  int nLow5 = 0.5 * Thickness / maxLayerh + 4;
  q["nLow5"] = nLow5;
  int curvedpts = 6;
  q["curvedpts"] = curvedpts;
  BLModel = std::make_shared<BLRectangle>(p, q);
  BLModel->Initialise();
}

double nearmaxLayerh = 0.1;
double nearBoxLeft = -1;
double nearBoxRight = ChordLen + 1;
double nearBoxDown = -2;
double nearBoxUp = 2;
double nearAoA = 0.;
double neargap = nearmaxLayerh;

double maxLayerhWake = 0.12;
double farWakeAoA = 0.;
