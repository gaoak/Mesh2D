...
//int N0x = findNlayers(hcenter, hgrowth, -p0x, 3*hfar);
int N1x = std::ceil((p1x - p0x)/(3*hfar));
//int N2x = findNlayers(hcenter, hgrowth, p3x, 3*hfar);
...
//LineEdge Cedge23(pts[2], pts[3], N1x, UNIFORM, 0., 0.);
...
//LineEdge Cedge89(pts[8], pts[9], N1x, UNIFORM, 0., 0.);
